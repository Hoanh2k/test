...
<div>
    <form action="/staff/search?userName=${userName}" method="get">
        <b>Mã màu </b><input name="userName"/>
...
<div>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <a href="/staff/add" class="btn btn-success">Thêm </a>
        </div>
        <hr>
<table class="table">
    <thead>
    ...
    <c:forEach items="${list}" var="st">
        <tr>
            ...
            <td>${st.userName}</td>
            <td>${st.passWord}</td>
            <td>${!st.status?"Nhân viên":"Admin"}</td>
            <td>
                <a href="/staff/update/${st.id}">Sửa</a>
                <a href="/staff/delete/${st.id}">Xóa</a>
                <a href="/staff/detail/${st.id}">Chi tiết</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
