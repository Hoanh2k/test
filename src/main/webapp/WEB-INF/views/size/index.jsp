...
<br>
<div>
    <form action="/size/search?code=${code}" method="get">
...
<div>
    <div class="card">
        ...
        <div class="card-body">
            <a href="/size/add" class="btn btn-success">Thêm size</a>
        </div>
        <hr>
        <table class="table">
            <thead>
            ...
            <c:forEach items="${list}" var="s">
                <tr>
                    ...
                    <td>${s.code}</td>
                    <td>${s.name}</td>
                    <td>${s.status?"Còn hàng":"Không còn hàng"}</td>
                    <td>
                        <a href="/size/update/${s.id}">Sửa</a>
                        <a href="/size/delete/${s.id}">Xóa</a>
                        <a href="/size/detail/${s.id}">Chi tiết</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
