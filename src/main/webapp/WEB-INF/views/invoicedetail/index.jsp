...
<div>
    <form action="/invoicedetail/search?code=${id}" method="get">
        <b>ID </b><input name="id"/>
...
<div>
    <div class="card">
        ...
        <div class="card-body">
            <a href="/invoicedetail/add" class="btn btn-success">Thêm </a>
        </div>
        <hr>
        ...
        <table class="table">
            ...
            <c:forEach items="${list}" var="st" varStatus="i">
                <tr>
                    ...
                    <td>${st.trangThai}</td>
                    <td>
                        <a href="/invoicedetail/update/${st.id}">Sửa </a>
                        <a href="/invoicedetail/detail/${st.id}">Chi tiết</a>
                        <a href="/invoicedetail/delete/${st.id}">Xóa</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
